...
class Lease(models.Model):
    # 出租人
    lor = models.ForeignKey(Lerror, verbose_name="出租人")
    # 承租人
    lee = models.ForeignKey(Lessee, verbose_name="承租人")
    # 出租物品
    goods = models.ForeignKey(Goods, verbose_name="出租物品")
    # 开始时间
    s_time = models.DateTimeField(verbose_name="开始时间",auto_now_add=True)
    # 最后一次修改时间
    last_modify = models.DateTimeField(auto_now=True)
    # 租金
    rent = models.ForeignKey(Goods,verbose_name="租金")
...
# 出租人表
class Lerror(models.Model,UserInfo):
    user = models.ForeignKey(UserInfo,verbose_name="出租人")
    goods = models.ForeignKey(Goods,verbose_name="出租物品")
    time = models.DateTimeField(verbose_name="",auto_now=True)
    # 显示多久前谁在干嘛
    cost = time.time() - time
    ...
    def __str__(self):
        return "{}正在出租了{},".format(self.user,self.goods)


# 承租人表
class Lessee(models.Model,UserInfo):
    us_id = models.ForeignKey(UserInfo,verbose_name="用户编号")
    g_id = models.ForeignKey(verbose_name="出租物品编号")
